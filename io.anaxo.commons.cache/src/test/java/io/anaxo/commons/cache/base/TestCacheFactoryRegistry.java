...
import io.anaxo.commons.cache.distributed.CoherenceCache;
import io.anaxo.commons.cache.distributed.CoherenceCacheFactory;
import io.anaxo.commons.cache.distributed.EHCache;
import io.anaxo.commons.cache.distributed.EHCacheFactory;
import io.anaxo.commons.cache.distributed.FKCache;
import io.anaxo.commons.cache.distributed.FKCacheFactory;
import io.anaxo.commons.cache.distributed.GigaspacesCache;
import io.anaxo.commons.cache.distributed.GigaspacesCacheFactory;
import io.anaxo.commons.cache.distributed.JCache;
import io.anaxo.commons.cache.distributed.JCacheFactory;
import io.anaxo.commons.cache.distributed.JcsCache;
import io.anaxo.commons.cache.distributed.JcsCacheFactory;
import io.anaxo.commons.cache.distributed.OsCache;
import io.anaxo.commons.cache.distributed.OsCacheFactory;
import io.anaxo.commons.cache.exceptions.PropertiesException;
import io.anaxo.commons.cache.hashbelt.FIFOHashbelt;
import io.anaxo.commons.cache.hashbelt.FIFOHashbeltFactory;
import io.anaxo.commons.cache.hashbelt.LRUHashbelt;
import io.anaxo.commons.cache.hashbelt.LRUHashbeltFactory;
import io.anaxo.commons.cache.simple.CountLimited;
import io.anaxo.commons.cache.simple.CountLimitedFactory;
import io.anaxo.commons.cache.simple.NoCache;
import io.anaxo.commons.cache.simple.NoCacheFactory;
import io.anaxo.commons.cache.simple.TimeLimited;
import io.anaxo.commons.cache.simple.TimeLimitedFactory;
import io.anaxo.commons.cache.simple.Unlimited;
import io.anaxo.commons.cache.simple.UnlimitedFactory;
import io.anaxo.commons.cache.util.AbstractProperties;
import io.anaxo.commons.cache.util.CacheProperties;
...
public final class TestCacheFactoryRegistry extends TestCase {
    ...
    public void testConstructor() {
        ...
        assertEquals("io.anaxo.commons.cache.Factories", CacheFactoryRegistry.CACHE_FACTORIES);
        ...
        properties.put(CacheFactoryRegistry.CACHE_FACTORIES, "io.anaxo.commons.cache.simple.UnknownFactory");
        try {
            new CacheFactoryRegistry<String, String>(properties);
