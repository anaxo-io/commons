 ...
 */
package io.anaxo.commons.cache.util;
...
public class CacheProperties extends AbstractProperties {
    ...
    private static final String FILEPATH = "/com/jpmorgan/qtrade/cache/";

    /** Name of Cache properties of core modul. */
    private static final String FILENAME = "qtrade.cache.properties";
     ...
     *  (<tt>io.anaxo.commons.cache.Factories</tt>). */
    public static final String CACHE_FACTORIES = "io.anaxo.commons.cache.Factories";
